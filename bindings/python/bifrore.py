...
class _MetricsSnapshot(ctypes.Structure):
    _fields_ = [
        ...
        ("core_eval_count", ctypes.c_uint64),
        ("core_eval_total_nanos", ctypes.c_uint64),
        ("core_eval_max_nanos", ctypes.c_uint64),
        ("worker_pipeline_count", ctypes.c_uint64),
        ("worker_pipeline_total_nanos", ctypes.c_uint64),
        ("worker_pipeline_max_nanos", ctypes.c_uint64),
...
class BifroRE:
    ...
    def metrics(self):
        ...
        return {
            ...
            "core_eval_count": snapshot.core_eval_count,
            "core_eval_total_nanos": snapshot.core_eval_total_nanos,
            "core_eval_max_nanos": snapshot.core_eval_max_nanos,
            "worker_pipeline_count": snapshot.worker_pipeline_count,
            "worker_pipeline_total_nanos": snapshot.worker_pipeline_total_nanos,
            "worker_pipeline_max_nanos": snapshot.worker_pipeline_max_nanos,
