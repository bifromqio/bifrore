...
JNIEXPORT jlongArray JNICALL Java_com_bifrore_BifroRE_nativeMetricsSnapshotValues(
    ...
    jlong values[] = {
        ...
        (jlong)snapshot.core_eval_count,
        (jlong)snapshot.core_eval_total_nanos,
        (jlong)snapshot.core_eval_max_nanos,
        (jlong)snapshot.worker_pipeline_count,
        (jlong)snapshot.worker_pipeline_total_nanos,
        (jlong)snapshot.worker_pipeline_max_nanos,
        (jlong)snapshot.eval_count,
        (jlong)snapshot.eval_error_count,
        (jlong)snapshot.eval_type_error_count,
        (jlong)snapshot.payload_schema_error_count,
        (jlong)snapshot.payload_decode_error_count,
        (jlong)snapshot.payload_build_error_count,
